...
function startGame() {
  ...
  hero = createEntity("hero", GAME_VARIABLES.VIEWPORT.width / 2, GAME_VARIABLES.VIEWPORT.height / 2);
  entities = [
    hero,
...
function updateCameraWindow() {
  // edge snapping
  if (0 < viewportOffsetX && hero.x < viewportOffsetX + GAME_VARIABLES.CAMERA_WINDOW_X) {
    viewportOffsetX = Math.max(0, hero.x - GAME_VARIABLES.CAMERA_WINDOW_X);
  } else if (
    viewportOffsetX < GAME_VARIABLES.MAP.width - GAME_VARIABLES.VIEWPORT.width &&
  ...
  if (0 < viewportOffsetY && hero.y < viewportOffsetY + GAME_VARIABLES.CAMERA_WINDOW_Y) {
    viewportOffsetY = Math.max(0, hero.y - GAME_VARIABLES.CAMERA_WINDOW_Y);
  } else if (
    viewportOffsetY < GAME_VARIABLES.MAP.height - GAME_VARIABLES.VIEWPORT.height &&
...
function render() {
  ...
  GAME_VARIABLES.VIEWPORT_CTX.fillRect(0, 0, GAME_VARIABLES.VIEWPORT.width, GAME_VARIABLES.VIEWPORT.height);
...
function renderMap() {
  ...
  GAME_VARIABLES.MAP_CTX.fillRect(0, 0, GAME_VARIABLES.MAP.width, GAME_VARIABLES.MAP.height);
...
function renderDebugTouch() {
  ...
  if (touches.length) {
    GAME_VARIABLES.VIEWPORT_CTX.strokeStyle = GAME_VARIABLES.VIEWPORT_CTX.fillStyle = "#02d";
